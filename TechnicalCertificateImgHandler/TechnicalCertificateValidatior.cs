...
namespace TechnicalCertificateImgHandler
{
    public class TechnicalCertificateValidatior : ITechnicalCertificateValidatior
    {
        ...
        /// </summary>
        public TechnicalCertificateValidatior() : this(new TechnicalCertificateValidatior(new List<string>()))
        {
        }
        ...
        public bool IsValid(VehicleCertificateContentDTO certificate)
        {
            ...
            {
                errors.Add(ApplicationKeys.TechnicalCertificateValidation.BSO_NUM_ERROR);
            }
